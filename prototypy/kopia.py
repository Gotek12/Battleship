...
def main():
    ...
    #             can2 = False
    #             for i in range(siz):
    #                 if not p1.grid[randX + i][randY].blocked:
    #                     can2 = True
    #                 else:
    #                     can2 = False
    #                     break
    ...
    #             if can2:
    #                 for i in range(siz):
    #                     p1.grid[randX + i][randY].blocked = True
    #                     p1.grid[randX + i][randY].color = RED
    #                 total = total + 1
    #                 break
    #
    #         if zeroOrOne == 1 and randY + siz < 10:
    #             can2 = False
    #             for i in range(siz):
    #                 if not p1.grid[randX][randY + i].blocked:
    #                     can2 = True
    #                 else:
    #                     can2 = False
    #                     break
    ...
    #             if can2:
    #                 for i in range(siz):
    #                     p1.grid[randX][randY + i].blocked = True
    #                     p1.grid[randX][randY + i].color = RED
    #                 total = total + 1
    #                 break
